Pod::Spec.new do |s|
  ...
  # s.subspec 'AzureCore' do |cs|
  #   cs.dependency 'Willow', '~> 5.0'
  #   cs.dependency 'KeychainAccess', '~> 3.1'
  #   cs.source_files = 'AzureCore/Source/*.{swift,h,m}'
  # end

  # s.dependency 'AzureData/AzureCore'
